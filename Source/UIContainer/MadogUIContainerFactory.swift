...
internal class MadogUIContainerFactory<T> {
    ...
    internal func addUICreationFunction(identifier: String, function: @escaping SplitSingleVCUIRegistryFunction<T>) -> Bool {
    ...
    internal func addUICreationFunction(identifier: String, function: @escaping SplitMultiVCUIRegistryFunction<T>) -> Bool {
    ...
    internal func createUI<VC, TD>(identifier: MadogUIIdentifier<VC, TD>,
                                   tokenData: TD) -> MadogModalUIContainer<T>? where VC: UIViewController, TD: TokenData {
